<template>
  <v-card class="ma-auto" :width="pageWidth">
    ...
    <v-card-text class="text-body-1">
      <div v-if="page == 1">
        ...
        <p>
          ...
          <span
            class="strong-1"
          >question</span> and a
          <span class="strong-1">set of facts</span> extracted from Wikipedia.
        </p>
        <p>
          Your task is to
      ...
      <div v-if="page == 6">
        <p>
          ...
          <span
            class="strong-1"
          >Fact 37</span> states that “Rings” is the third film in “The Ring” series. That's our answer!
        </p>
        <p>
          Now we
          <span class="strong-1">click</span> on Fact 37 to select it, and we <span class="strong-1">type</span> the answer “Rings” in the answer box. Finally, after selecting all the supporting facts and typing in the answer, we click <span class="strong-1">Submit and Next Question</span> to submit the answer/supporting facts and go to the next question.
        </p>
        <v-divider class="my-5"></v-divider>
      ...
      <div v-if="page == 8">
        <p>Now comes the real part.</p>
        <p>In this interface, the facts are no longer grouped by their topic. Rather, they are <span class="strong-1">ordered by their similarity to the question as well as the already selected supporting facts</span>. At the start when there is no selected fact, the facts are simply ordered by their similarity to the question.</p>
        <p>Whenever you click on a fact and select it as supporting fact, all the facts will be re-ordered by their similarity to the question <span class="strong-2">and</span> all the fact you have selected, so you'll see facts moving around when you click.</p>
